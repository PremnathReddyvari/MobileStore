	...
	<body>
		...
		<c:forEach items="${list}" var="lb">
			<div class="col-md-4">
				<div class="thumbnail">
					<img
						src="<c:url value='images/androidDir/${lb.getReferenceNumber()}.png'/>"
						alt="noimg">
					<div class="caption">
						<h4>
							<a href="#">Android</a>
...
<!-- 						<form action="GetAndroidSession" method="post">
 ...
 -->			<a href="GetAndroidSession?referenceNumber=<c:out value="${lb.referenceNumber}"/>&productName=<c:out value="${lb.productName}"/> &productCompany=<c:out value="${lb.productCompany}"/> &productPrice=<c:out value="${lb.productPrice}"/>"><b><big><button>Buy Now</button></big></b></a> 
