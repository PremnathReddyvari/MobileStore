...
<body>
	...
	<ul>
		<li><a href="InsertAndroid.jsp" name="ps">Insert New Phones</a></li>
	...
	<center>
		...
		<p style="font-size: 20px;">
			Welcome, <br>List of All the Products in The Database.
		</p>
		</head>
		<body>
			<table border=1>
